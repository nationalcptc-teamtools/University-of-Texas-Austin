...
\newcommand{\vulnreport}[1][]{%
    ...
    {\fontfamily{phv}\selectfont
        \begin{fullfindingbox}[title=\vspace{0.4cm}\begin{tabular}{@{}p{2cm}@{}l@{}} \Large\textbf{\vulnreport@number} & \Large\textbf{\vulnreport@title} \end{tabular}\vspace{0.3cm}, colframe=\curfgcolor, colbacktitle=\curbgcolor, coltitle=\curfgcolor]{}
